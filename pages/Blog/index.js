...
function index() {
 ...
 <div className="xl:mx-16 lg:mx-8">
      ...
      <div className="Actor_font flex flex-col gap-8 md:text-2xl text-xl text-justify">
        <p>
        How can you ensure that your vote counts in the upcoming election? 
         ...
         make in the outcome of the election? Voting is one of the most important rights
          we have as citizens of this country, and it’s not to be taken lightly or neglected.
           ...
           affects change in our country – and you won’t waste your time or money when you head
            to the polls on Election Day. Read on to find out how!.{" "}
        </p>
        <p>
        The history of elections in Kenya dates back to the independence of the nation in 1963. Before that, voting was a privilege reserved for only a select few. Since then, Kenya has made great strides in expanding and protecting citizens’ right to vote.
...
.{" "}
        ...
        <p>
        Voting is a cornerstone of democracy, and it is vitally important that citizens exercise their right to vote. In Kenya, voting has become a fundamental aspect of everyday life, as the country continues to strive for progress and a brighter future. By participating in elections, citizens can ensure that their voice is heard and that their rights are protected. 
Voting in Kenya is not only important for political reasons, but also for economic reasons. When citizens vote, they are contributing to the economic stability of the country. By engaging in the electoral process, citizens are empowering their leaders to make decisions that will have a positive impact on their lives. With the right leaders in office, Kenyans can expect to see improvements in areas such as infrastructure, education, and healthcare. 
Additionally, voting in Kenya serves as a tool for social change. With more people actively engaged in the electoral process, people can take part in shaping the future of their nation. By voting for candidates that support their values, citizens are ensuring that their opinions are heard and respected by those in power. It is through this collective action that Kenyans can work together to create a better future for their country. 
At the end of the day, it is up to each citizen to make their voice heard. Every Kenyan has the right to vote, and it is important that they use that right responsibly and effectively. By understanding the importance of voting in Kenya, citizens can make sure that their votes count and that they are working towards creating a better future for all.
.{" "}
        </p>
        <p>
        Voting is a critical part of the democratic process and is essential to have your voice heard. In Kenya, the process of registering to vote is straightforward and easy. All citizens over the age of 18 are eligible to register to vote, and it is important to do so in order to ensure that you have a say in the political system.
The first step to registering to vote is to visit the electoral body in Kenya, the Independent Electoral and Boundaries Commission (IEBC). At the IEBC, you will be asked to fill out a form with your personal details. The form will ask for your name, date of birth, address, phone number, and other relevant information. Once you have filled out the form, you will be given a voter card with your name and ID number. This voter card must be shown when voting.
In addition to registering at the IEBC office, citizens can also register to vote online. The IEBC has a website where individuals can fill out an application and submit it electronically. This can be done through a laptop or a mobile device. After submitting the application, applicants will receive a confirmation email with their voter card information. 
Finally, those who are unable to register online or at the IEBC office can register via SMS. To do this, applicants must send their name and national ID number to a designated number. Upon receipt of the SMS, applicants will receive a confirmation message with their voter card details. 
No matter which method you choose, registering to vote is essential for having your voice heard in the democratic process. It is important that all Kenyan citizens take advantage of their right to vote and make their voices heard in the upcoming elections.
.
        </p>
        <p>
        Voting is an important part of any democratic society, and Kenya is no exception. 
        It is essential for citizens to exercise their right to vote in order to make sure 
        their voices are heard. As Kenyan citizens, it is our duty to ensure that our votes 
        count towards the future of the nation. By being informed, educated, and engaged in 
        the voting process, we can all work together to ensure that our elections are fair,
         transparent, and result in a better future for all Kenyans. Thank you for taking the 
         time to read this blog post and learn more about the importance of voting in Kenya.
          Let's all make sure that our votes count!
        </p>
      </div></div>
    </>
  )
