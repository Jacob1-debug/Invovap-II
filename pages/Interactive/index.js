...
function index() {
  return (
    <>
     ...
     Welcome to Our Interactive page
      </h2>
      <p className='Actor_font md:text-2xl text-xl md:mx-16 mx-4'>A stone hand-picked from the river Thames and brought to Flat 8. 
Fresh handmade pizzas can be made on this stone provided the oven 
temperature can be regulated. </p>
